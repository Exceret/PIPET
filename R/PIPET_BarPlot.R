...
#     tmp <- data.frame(
#         Var1 = SC@meta.data[[group]],
#         Var2 = SC@meta.data[[prediction]]
#     )

#     if (is.factor(tmp[, "Var1"])) {
#         message(paste0("The levels of ", group, " are: "))
#         print(levels(tmp[, "Var1"]))
#         message(paste0(
#             "If the order of levels is not appropriate, please re-customize ",
#             group,
#             "."
#         ))
#     } else {
...
#         message(paste0(
#             group,
#             " has been automatically converted to factor type.",
#             "If the order of levels is not appropriate, please re-customize ",
#             group,
#             "."
#         ))
